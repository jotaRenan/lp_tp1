...
"\
\\001\000\001\000\111\000\007\000\111\000\008\000\111\000\019\000\111\000\
...
\\028\000\111\000\033\000\125\000\034\000\111\000\042\000\125\000\
\\043\000\125\000\045\000\125\000\046\000\111\000\000\000\
\\001\000\001\000\125\000\007\000\125\000\008\000\125\000\019\000\125\000\
\\020\000\125\000\021\000\125\000\022\000\125\000\023\000\125\000\
\\024\000\125\000\025\000\125\000\026\000\125\000\027\000\125\000\
\\028\000\125\000\033\000\125\000\034\000\125\000\042\000\125\000\
\\043\000\125\000\045\000\125\000\046\000\125\000\000\000\
\\001\000\001\000\023\000\000\000\
\\001\000\001\000\035\000\007\000\069\000\019\000\034\000\020\000\033\000\
\\021\000\032\000\022\000\031\000\023\000\030\000\024\000\029\000\
\\025\000\028\000\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\001\000\001\000\035\000\008\000\086\000\019\000\034\000\020\000\033\000\
\\021\000\032\000\022\000\031\000\023\000\030\000\024\000\029\000\
\\025\000\028\000\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\001\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\001\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\034\000\064\000\000\000\
\\001\000\001\000\087\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
...
\\001\000\006\000\019\000\011\000\018\000\012\000\042\000\013\000\041\000\
\\014\000\040\000\015\000\017\000\016\000\016\000\017\000\015\000\
\\018\000\014\000\020\000\013\000\029\000\068\000\033\000\067\000\
\\034\000\038\000\042\000\011\000\043\000\010\000\044\000\009\000\
\\045\000\008\000\000\000\
\\001\000\006\000\019\000\011\000\018\000\012\000\042\000\013\000\041\000\
\\014\000\040\000\015\000\017\000\016\000\016\000\017\000\015\000\
\\018\000\014\000\020\000\013\000\033\000\039\000\034\000\038\000\
...
\\042\000\011\000\043\000\010\000\044\000\009\000\045\000\008\000\000\000\
\\001\000\012\000\042\000\013\000\041\000\014\000\040\000\029\000\068\000\
\\033\000\078\000\000\000\
\\001\000\024\000\070\000\000\000\
\\001\000\029\000\063\000\000\000\
\\001\000\030\000\071\000\000\000\
\\001\000\030\000\085\000\037\000\072\000\000\000\
\\001\000\034\000\073\000\037\000\072\000\000\000\
\\001\000\034\000\073\000\037\000\072\000\039\000\084\000\000\000\
\\001\000\034\000\081\000\000\000\
\\001\000\034\000\083\000\000\000\
\\001\000\042\000\050\000\000\000\
\\001\000\046\000\000\000\000\000\
\\094\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\095\000\000\000\
\\096\000\000\000\
\\097\000\033\000\012\000\042\000\011\000\043\000\010\000\045\000\022\000\000\000\
\\098\000\033\000\012\000\042\000\011\000\043\000\010\000\045\000\022\000\000\000\
\\099\000\000\000\
\\100\000\000\000\
\\101\000\000\000\
\\102\000\000\000\
...
\\108\000\000\000\
\\109\000\000\000\
\\110\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\112\000\000\000\
\\113\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\114\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\115\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\116\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\117\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\118\000\001\000\035\000\019\000\034\000\020\000\033\000\021\000\032\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\025\000\028\000\
\\026\000\027\000\027\000\026\000\028\000\025\000\000\000\
\\119\000\000\000\
\\120\000\000\000\
...
\\128\000\000\000\
\\129\000\000\000\
\\129\000\029\000\063\000\000\000\
\\130\000\000\000\
\\131\000\000\000\
\\132\000\037\000\072\000\000\000\
\\133\000\000\000\
\\134\000\000\000\
\\135\000\000\000\
\\136\000\000\000\
\\137\000\037\000\072\000\039\000\084\000\000\000\
\\138\000\000\000\
\"
val actionRowNumbers =
"\008\000\027\000\002\000\047\000\
\\026\000\023\000\000\000\040\000\
\\052\000\048\000\010\000\011\000\
\\011\000\011\000\011\000\011\000\
\\011\000\011\000\021\000\051\000\
\\001\000\008\000\050\000\011\000\
\\011\000\011\000\011\000\011\000\
\\011\000\011\000\011\000\011\000\
\\011\000\011\000\014\000\006\000\
\\053\000\009\000\060\000\062\000\
\\061\000\038\000\039\000\044\000\
\\043\000\042\000\041\000\003\000\
\\013\000\024\000\045\000\037\000\
\\036\000\035\000\030\000\034\000\
\\032\000\031\000\029\000\028\000\
\\046\000\015\000\049\000\056\000\
\\017\000\009\000\012\000\011\000\
\\011\000\019\000\012\000\063\000\
\\020\000\018\000\055\000\016\000\
\\012\000\004\000\007\000\054\000\
\\059\000\057\000\012\000\058\000\
\\011\000\008\000\065\000\064\000\
\\033\000\005\000\025\000\022\000"
val gotoT =
"\
\\001\000\091\000\002\000\005\000\003\000\004\000\004\000\003\000\
...
\\000\000\
\\000\000\
\\002\000\035\000\003\000\004\000\004\000\003\000\007\000\001\000\
...
\\000\000\
\\002\000\035\000\003\000\004\000\004\000\003\000\007\000\001\000\
\\008\000\064\000\010\000\063\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\002\000\035\000\003\000\004\000\004\000\003\000\007\000\001\000\
\\008\000\073\000\009\000\072\000\010\000\063\000\000\000\
\\008\000\075\000\010\000\074\000\000\000\
\\002\000\077\000\003\000\004\000\004\000\003\000\007\000\001\000\000\000\
\\002\000\078\000\003\000\004\000\004\000\003\000\007\000\001\000\000\000\
\\000\000\
\\008\000\080\000\010\000\074\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\008\000\073\000\009\000\072\000\010\000\074\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\008\000\087\000\009\000\086\000\010\000\074\000\000\000\
\\000\000\
\\002\000\088\000\003\000\004\000\004\000\003\000\007\000\001\000\000\000\
\\001\000\090\000\002\000\089\000\003\000\004\000\004\000\003\000\
\\005\000\002\000\007\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | Params of unit ->  (plcType list) | AtomType of unit ->  (plcType)
 | Types of unit ->  (plcType list) | Type of unit ->  (plcType)
 | AppExpr of unit ->  (expr) | TypedVar of unit ->  (plcType*string)
...
|  ( 28, ( ( _, ( MlyValue.AtomExpr AtomExpr2, _, AtomExpr2right)) :: 
...
|  ( 29, ( ( _, ( MlyValue.AtomExpr AtomExpr1, _, AtomExpr1right)) :: 
...
|  ( 32, ( ( _, ( _, FALSE1left, FALSE1right)) :: rest671)) => let
 val  result = MlyValue.Const (fn _ => (ConB(true)))
 in ( LrTable.NT 3, ( result, FALSE1left, FALSE1right), rest671)
end
...
|  ( 34, ( ( _, ( _, _, RPAREN1right)) :: _ :: _ :: ( _, ( 
MlyValue.AtomType AtomType1, _, _)) :: ( _, ( _, LPAREN1left, _)) :: 
rest671)) => let val  result = MlyValue.Const (fn _ => let val  (
AtomType as AtomType1) = AtomType1 ()
 in (ESeq(AtomType))
end)
 in ( LrTable.NT 3, ( result, LPAREN1left, RPAREN1right), rest671)
end
|  ( 35, ( ( _, ( MlyValue.AtomType AtomType1, AtomType1left, 
...
|  ( 36, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.Types Types1
, _, _)) :: ( _, ( _, LPAREN1left, _)) :: rest671)) => let val  result
...
|  ( 37, ( ( _, ( _, _, RSB1right)) :: ( _, ( MlyValue.Type Type1, _,
...
|  ( 38, ( ( _, ( MlyValue.Type Type2, _, Type2right)) :: _ :: ( _, ( 
...
|  ( 42, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.Type Type1,
 _, _)) :: ( _, ( _, LPAREN1left, _)) :: rest671)) => let val  result
...
|  ( 43, ( ( _, ( MlyValue.Type Type2, _, Type2right)) :: _ :: ( _, ( 
MlyValue.Type Type1, Type1left, _)) :: rest671)) => let val  result = 
...
|  ( 44, ( ( _, ( MlyValue.Types Types1, _, Types1right)) :: _ :: ( _,
 ( MlyValue.Type Type1, Type1left, _)) :: rest671)) => let val  result

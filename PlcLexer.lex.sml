...
\\014\003\003\003\003\003\003\003\003\003\013\012\003\011\003\010\
...
{fin = [], trans = 1},
{fin = [(N 24)], trans = 0},
{fin = [(N 10),(N 24)], trans = 4},
{fin = [(N 10)], trans = 4},
{fin = [(N 22),(N 24)], trans = 0},
{fin = [(N 20),(N 24)], trans = 0},
{fin = [(N 7),(N 24)], trans = 8},
{fin = [(N 7)], trans = 8},
{fin = [(N 18),(N 24)], trans = 0},
...
| 22 => (EQ(yypos, yypos))
| 24 => (error("error"); raise Fail("error"))
| 4 => (lex())

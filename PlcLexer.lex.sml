...
{fin = [], trans = 1},
{fin = [(N 64)], trans = 0},
{fin = [(N 37),(N 64)], trans = 0},
{fin = [(N 54),(N 64)], trans = 0},
{fin = [(N 35),(N 64)], trans = 0},
{fin = [(N 10),(N 64)], trans = 7},
{fin = [(N 10)], trans = 7},
{fin = [(N 33),(N 64)], trans = 0},
{fin = [(N 31),(N 64)], trans = 0},
{fin = [(N 25),(N 64)], trans = 11},
{fin = [(N 60)], trans = 0},
{fin = [(N 45),(N 64)], trans = 13},
{fin = [(N 48)], trans = 0},
{fin = [(N 20),(N 64)], trans = 0},
{fin = [(N 62),(N 64)], trans = 16},
{fin = [(N 23)], trans = 0},
{fin = [(N 7),(N 64)], trans = 18},
{fin = [(N 7)], trans = 18},
{fin = [(N 18),(N 64)], trans = 0},
{fin = [(N 14),(N 64)], trans = 21},
{fin = [(N 57)], trans = 0},
{fin = [(N 52),(N 64)], trans = 0},
{fin = [(N 12),(N 64)], trans = 0},
{fin = [(N 16),(N 64)], trans = 0},
{fin = [(N 29),(N 64)], trans = 0},
{fin = [(N 27),(N 64)], trans = 0},
{fin = [(N 64)], trans = 28},
{fin = [(N 40)], trans = 0},
{fin = [(N 50),(N 64)], trans = 30},
{fin = [(N 43)], trans = 0},
...
| 54 => (PIPE(yypos, yypos))
| 57 => (THINARR(yypos, yypos))
| 60 => (FATARR(yypos, yypos))
| 62 => (COL(yypos, yypos))

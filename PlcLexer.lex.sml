...
{fin = [], trans = 1},
{fin = [(N 28)], trans = 0},
{fin = [(N 10),(N 28)], trans = 4},
{fin = [(N 10)], trans = 4},
{fin = [(N 22),(N 28)], trans = 0},
{fin = [(N 20),(N 28)], trans = 0},
{fin = [(N 7),(N 28)], trans = 8},
{fin = [(N 7)], trans = 8},
{fin = [(N 18),(N 28)], trans = 0},
{fin = [(N 14),(N 28)], trans = 0},
{fin = [(N 12),(N 28)], trans = 0},
{fin = [(N 16),(N 28)], trans = 0},
...
| 28 => (error("error"); raise Fail("error"))
| 4 => (lex())

...
{fin = [], trans = 1},
{fin = [(N 66)], trans = 0},
{fin = [(N 37),(N 66)], trans = 0},
{fin = [(N 54),(N 66)], trans = 0},
{fin = [(N 35),(N 66)], trans = 0},
{fin = [(N 10),(N 66)], trans = 7},
{fin = [(N 10)], trans = 7},
{fin = [(N 10),(N 64),(N 66)], trans = 7},
{fin = [(N 33),(N 66)], trans = 0},
{fin = [(N 31),(N 66)], trans = 0},
{fin = [(N 25),(N 66)], trans = 12},
{fin = [(N 60)], trans = 0},
{fin = [(N 45),(N 66)], trans = 14},
{fin = [(N 48)], trans = 0},
{fin = [(N 20),(N 66)], trans = 0},
{fin = [(N 62),(N 66)], trans = 17},
{fin = [(N 23)], trans = 0},
...
{fin = [(N 29),(N 66)], trans = 0},
{fin = [(N 27),(N 66)], trans = 0},
{fin = [(N 66)], trans = 29},
{fin = [(N 40)], trans = 0},
{fin = [(N 50),(N 66)], trans = 31},
{fin = [(N 43)], trans = 0},
